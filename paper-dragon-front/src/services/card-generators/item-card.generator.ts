import { ItemCardTemplate, type ItemCardData } from "../../components/cards/card-type.types";
...
export function createItemCardFront(cardData: ItemCardData = ItemCardTemplate) {
