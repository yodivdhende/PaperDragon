import { MinionCardTemplate, type MinionCardData } from "../../components/cards/card-type.types";
...
export function createMinionCardFront(cardData: MinionCardData= MinionCardTemplate) {
    ...
    cardElement.appendChild(createElement(cardData.passive.toString(), 'effect'));
