...
export function getDefaultTemplate(cardType: CardType): CardData {
	switch (cardType) {
		case CARDTYPES.attack:
			return AttackCardTemplate;
		case CARDTYPES.maneuver:
			return ManeuverCardTemplate;
		case CARDTYPES.item:
			return ItemCardTemplate;
		case CARDTYPES.status:
			return StatusCardTemplate;
		case CARDTYPES.condition:
			return ConditionCardTemplate;
		case CARDTYPES.minions:
			return MinionCardTemplate;
		case CARDTYPES.bosses:
			return BossCardTemplate;
		case CARDTYPES.artifacts:
			return ArtifactCardTemplate;
		case CARDTYPES.backgrounds:
			return BackgroundCardTemplate;
		case CARDTYPES.trap:
			return TrapCardTemplate;
		case CARDTYPES.locations:
			return LocationCardTemplate;
	}
}
